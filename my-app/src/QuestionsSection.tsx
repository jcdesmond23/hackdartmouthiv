  ...
  return (
    <>
      <div className="grid h-[1550px] bg-center bg-[url('../public/sponsorsbackground.png')] -mb-[130px] bg-auto">
              ...
              <div className="flex flex-col sm:flex-row px-4 sm:px-8 pt-6 sm:pt-12 mt-4 sm:mt-12 mb-2 sm:mb-4 mx-auto col-start-1 row-start-1">
                  <img className="self-start mt-1" src="/FAQ.svg" alt="FAQ"/>
                  <div className="flex flex-col space-y-8 sm:space-y-16 flex-1 text-xs sm:text-sm px-2 sm:px-8">
                  ...
                  <div className="flex flex-col space-y-8 sm:space-y-16 flex-1 sm:text-sm px-2 sm:px-8 text-xs px-2">
